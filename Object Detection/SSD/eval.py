...
parser.add_argument('--trained_model',
                    default='weights/ssd300_VOC_50000.pth', type=str,
...
#                           'Main', '{:s}.txt')
imgsetpath = os.path.join(args.voc_root, 'VOC2012', 'ImageSets', 'Main', '{}.txt')
YEAR = '2012'
...
def do_python_eval(output_dir='output', use_07=True):
    ...
    for i, cls in enumerate(labelmap):
        filename = get_voc_results_file_template(set_type, cls)
        print('--filename, annopath, imgsetpath.format', filename, annopath)
